document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchMeetupEvents() {
        ...
        if (isLocal) {
            ...
            // For production, use a different CORS proxy with full headers
            const proxyUrl = 'https://api.allorigins.win/raw?url=' + encodeURIComponent('https://www.meetup.com/code-coffee-philly/');
